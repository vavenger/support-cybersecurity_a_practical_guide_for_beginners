...
| 53 | ファイル選択ウインドウにて、ダウンロードしたKali Linuxの仮想ディスクイメージkali-linux-2025.2-qemu-amd64.qcow2ファイルを選択します。 | ファイル選択ウインドウにて、ダウンロードした「.7z」圧縮ファイルを展開して得られる、Kali Linuxの仮想ディスクイメージkali-linux-2025.2-qemu-amd64.qcow2ファイルを選択します。 ※手順の加筆 | 1刷 | 2025.09.19 |
| 200 | `explorer.exe` (`PID: 14562`) | `explorer.exe` (`PID: 1456`) | 1刷 | 2025.09.23 |