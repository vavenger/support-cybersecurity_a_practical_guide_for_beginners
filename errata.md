...
| 053 | ファイル選択ウインドウにて、ダウンロードしたKali Linuxの仮想ディスクイメージkali-linux-2025.2-qemu-amd64.qcow2ファイルを選択します。 | ファイル選択ウインドウにて、ダウンロードした「.7z」圧縮ファイルを展開して得られる、Kali Linuxの仮想ディスクイメージkali-linux-2025.2-qemu-amd64.qcow2ファイルを選択します。 ※手順の加筆 | 1刷 | 2025.09.19 |
| 138 | cochrimato[.]com（95[.]181[.]198[.]231） | klychenogg[.]com（95[.]181[.]198[.]231）, Host名の記載誤り | 1刷 | 2025.11.26 |
| 161 | $ grep '14/Jan/2021:05' access.log \| grep -E '119.241.22.121\|168.22.54.119' \| awk -F '"' '{print $2}' \| sort \| uniq -c \| sort -r \| head -n 20 | $ grep '14/Jan/2021:05' access.log \| grep -E '119.241.22.121\|168.22.54.119' \| awk -F '"' '{print $2}' \| sort \| uniq -c \| sort -nr \| head -n 20, 後段sortコマンドの-nオプションの不足、数値扱いしていない。 | 1刷 | 2026.04.21 |
| 066 | 図 1.53 /usr/sdin, 追加のアプリケーションやユーザー用プログラム、ライブラリ、ドキュメントなどを格納 | /usr/sbin, 追加のアプリケーションやユーザー用プログラム、ライブラリ、ドキュメントなどを格納 | 1刷 | 2026.06.04 |
| 200 | explorer.exe（PID: 14562） | explorer.exe（PID: 1456）, PIDの記載誤り。リスト 5.1の記載が正、本文中のPIDは誤り | 1刷 | 2026.08.20 |