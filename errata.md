...
| 161 | $ grep '14/Jan/2021:05' access.log \| grep -E '119.241.22.121\|168.22.54.119' \| awk -F '"' '{print $2}' \| sort \| uniq -c \| sort -r \| head -n 20 | $ grep '14/Jan/2021:05' access.log \| grep -E '119.241.22.121\|168.22.54.119' \| awk -F '"' '{print $2}' \| sort \| uniq -c \| sort -rn \| head -n 20, 後段sortコマンドの-nオプションの不足、数値扱いしていない。 | 1刷 | 2026.04.21 |